...
class KeyTests: XCTestCase {
    ...
    func testKeyCollectionKey() {
        ...
        XCTAssertEqual("F" + Note.sharpTag + "1", keys.touched(by: CGPoint(x: 64.0 * 4 - 1, y: 0))?.note.label)
        ...
        XCTAssertEqual("G" + Note.sharpTag + "1", keys.touched(by: CGPoint(x: 64 * 5, y: 0))?.note.label)
