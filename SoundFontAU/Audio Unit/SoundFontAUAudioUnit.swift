...
public class SoundFontAUAudioUnit: AUAudioUnit {
    private let parameters: SoundFontAUParameters
    private let kernelAdapter: SoundFontAUDSPKernelAdapter
    ...
    public override init(componentDescription: AudioComponentDescription,
        ...
        kernelAdapter = SoundFontAUDSPKernelAdapter()

        // Create parameters object to control paramOne
        parameters = SoundFontAUParameters(kernelAdapter: kernelAdapter)
