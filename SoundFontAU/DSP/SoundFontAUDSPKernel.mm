...
#import "SoundFontAUDSPKernel.hpp"
#import "SoundFontAUDSPKernelAdapter.h"

@implementation SoundFontAUDSPKernelAdapter {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    SoundFontAUDSPKernel  _kernel;
...
- (AUInternalRenderBlock)internalRenderBlock {
    ...
    __block SoundFontAUDSPKernel *state = &_kernel;
