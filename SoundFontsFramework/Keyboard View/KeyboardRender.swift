...
//  SoundFonts
//
//  Created by Brad Howes on 3/11/20.
//  Copyright © 2020 B-Ray Software. All rights reserved.
//
...
public class KeyboardRender : NSObject {
    ...
    @objc dynamic public class func drawWhiteKey(keySize: CGSize = CGSize(width: 64, height: 240), roundedCorner: CGFloat = 12, pressed: Bool = false, isMuted: Bool = false, note: String = "C4") {
        ...
        //// Text Drawing
        let textRect = CGRect(x: frame.minX + fastFloor((frame.width - 11) * 0.13208 + 0.5), y: frame.minY + 209, width: frame.width - 11 - fastFloor((frame.width - 11) * 0.13208 + 0.5), height: fastFloor((frame.height - 209) * 0.67742 + 0.5))
