...
class FormattersTests: XCTestCase {
  ...
  func testAddSoundFontFailureText() {
    ...
    case "en":
      ...
      XCTAssertEqual(
        "2 empty files (one, two)",
        Formatters.makeAddSoundFontFailureText(failures: [
          .emptyFile("one"),
          .emptyFile("two"),
        ]))
      XCTAssertEqual(
        "1 invalid file (two), 2 empty files (one, three)",
        Formatters.makeAddSoundFontFailureText(failures: [
          .emptyFile("one"),
          .invalidFile("two"),
          .emptyFile("three"),
      ...
      XCTAssertEqual(
        "1 invalid file (two), 2 failed to install (four, six), 3 empty files (one, three, five)",
        Formatters.makeAddSoundFontFailureText(failures: [
          .emptyFile("one"),
          .invalidFile("two"),
          .emptyFile("three"),
