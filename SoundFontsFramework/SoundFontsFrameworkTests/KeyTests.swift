...
class KeyTests: XCTestCase {
  ...
  func testKeyCollectionKey() {
    let keys = makeKeys()
    XCTAssertNil(keys.touched(by: CGPoint(x: -0.0001, y: 0.0)))
    XCTAssertEqual("C1", keys.touched(by: CGPoint(x: 37, y: 0))?.note.label)
    XCTAssertEqual("C1", keys.touched(by: CGPoint(x: 37, y: 60))?.note.label)
    XCTAssertEqual("C1", keys.touched(by: CGPoint(x: 38, y: 60))?.note.label)
    XCTAssertEqual("C1", keys.touched(by: CGPoint(x: 63.9, y: 60))?.note.label)

    XCTAssertEqual("C" + Note.sharpTag + "1", keys.touched(by: CGPoint(x: 38, y: 59))?.note.label)
    XCTAssertEqual("C" + Note.sharpTag + "1", keys.touched(by: CGPoint(x: 89, y: 59))?.note.label)

    XCTAssertEqual("D1", keys.touched(by: CGPoint(x: 90, y: 0))?.note.label)
    XCTAssertEqual("D1", keys.touched(by: CGPoint(x: 64 * 1, y: 60))?.note.label)
    XCTAssertEqual("D1", keys.touched(by: CGPoint(x: 64 * 2 - 1, y: 60))?.note.label)
    XCTAssertEqual("E1", keys.touched(by: CGPoint(x: 64 * 2, y: 60))?.note.label)
    XCTAssertEqual("E1", keys.touched(by: CGPoint(x: 64 * 3 - 1, y: 0))?.note.label)
    XCTAssertEqual("F1", keys.touched(by: CGPoint(x: 64 * 3, y: 0))?.note.label)
    XCTAssertEqual("F1", keys.touched(by: CGPoint(x: 64 * 4 - 1, y: 60))?.note.label)
    XCTAssertEqual(
      "F" + Note.sharpTag + "1", keys.touched(by: CGPoint(x: 64.0 * 4 - 1, y: 0))?.note.label)
    XCTAssertEqual("G1", keys.touched(by: CGPoint(x: 64 * 4, y: 60))?.note.label)
    XCTAssertEqual("G1", keys.touched(by: CGPoint(x: 64 * 5 - 1, y: 60))?.note.label)
    XCTAssertEqual(
      "G" + Note.sharpTag + "1", keys.touched(by: CGPoint(x: 64 * 5, y: 0))?.note.label)
    XCTAssertEqual("A1", keys.touched(by: CGPoint(x: 64 * 5, y: 60))?.note.label)
    XCTAssertEqual("A1", keys.touched(by: CGPoint(x: 64 * 6 - 1, y: 60))?.note.label)
    XCTAssertEqual(
      "A" + Note.sharpTag + "1", keys.touched(by: CGPoint(x: 64 * 6, y: 0))?.note.label)
