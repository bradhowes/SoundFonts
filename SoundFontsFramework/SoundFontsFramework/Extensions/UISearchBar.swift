...
extension UISearchBar {
  ...
  var searchTerm: String? { self.text?.trimmedWhiteSpacesOrNil }
  var nonNilSearchTerm: String { return self.text?.trimmedWhiteSpaces ?? "" }
   ...
   */
  func beginSearch(with term: String) {
    text = term
