...
//  SoundFonts
//
//  Created by Brad Howes on 12/12/19.
//  Copyright © 2019 B-Ray Software. All rights reserved.
//
...
public class KeyboardRender : NSObject {
    ...
    @objc dynamic public class func drawWhiteKey(keySize: CGSize = CGSize(width: 64, height: 240), roundedCorner: CGFloat = 12, pressed: Bool = false, isMuted: Bool = false) {
