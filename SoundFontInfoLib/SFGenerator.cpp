...
struct UnsignedFull {
    static constexpr float min() { return 0.0; }
    static constexpr float max() { return std::numeric_limits<uint16_t>::max(); }
    static constexpr float initial() { return min(); }
    static std::function<float (SFGenTypeAmount)> getter() {return GenDef::fromUnsigned; }
};

template <int Min, int Max>
struct Unsigned {
    static constexpr float min() { return Min; }
    static constexpr float max() { return Max; }
    static constexpr float initial() { return min(); }
    static std::function<float (SFGenTypeAmount)> getter() {return GenDef::fromUnsigned; }
};
...
struct Signed {
    static constexpr float min() { return Min; }
    static constexpr float max() { return Max; }
    static constexpr float initial() { return 0.0; }
    static std::function<float (SFGenTypeAmount)> getter() {return GenDef::fromSigned; }
};

struct Cent {
    static constexpr float min() { return  1549; } // 20 Hz
    static constexpr float max() { return 13508; } // 20 kHz
    static constexpr float initial() { return 13500; }
    static std::function<float (SFGenTypeAmount)> getter() {return GenDef::fromUnsigned; }
};

struct CentBel {
    static constexpr float min() { return   0; }
    static constexpr float max() { return 960; }
    static constexpr float initial() { return min(); }
    static std::function<float (SFGenTypeAmount)> getter() {return GenDef::fromUnsigned; }
};

struct CentBelFs {
    static constexpr float min() { return -960; }
    static constexpr float max() { return  960; }
    static constexpr float initial() { return 0; }
    static std::function<float (SFGenTypeAmount)> getter() {return GenDef::fromUnsigned; }
};

struct TenthPercent {
    static constexpr float min() { return 0; }
    static constexpr float max() { return  1000; }
    static constexpr float initial() { return 0; }
    static std::function<float (SFGenTypeAmount)> getter() {return GenDef::fromUnsigned; }
};
...
std::vector<GenDef> const SFGenerator::defs = {
     ...
     */
    GenDef("startAddrsOffset", UnsignedFull()),
    /**
     ...
     */
    GenDef("endAddrsOffset", UnsignedFull()),
    /**
     ...
     */
    GenDef("startLoopAddrsOffset", UnsignedFull()),
    /**
     ...
     */
    GenDef("endLoopAddrsOffset", UnsignedFull()),
    /**
     ...
     */
    GenDef("startAddrsCoarseOffset", UnsignedFull()),
    // 5
    /**
     ...
     fall one semitone.
     */
    GenDef("modLFO2Pitch", Signed<-12000, 12000>()),
    /**
     ...
     fall one semitone.
     */
    GenDef("vibLFO2Pitch", Signed<-12000, 12000>()),
    /**
     ...
     */
    GenDef("modEnvToPitch", Signed<-12000, 12000>()),
    /**
     ...
     */
    GenDef("modLFO2FilterFc", Signed<-12000, 12000>()),
    /**
     ...
     */
    GenDef("modEnv2FilterFc", Signed<-12000, 12000>()),
    /**
     ...
     */
    GenDef("endAddrsCoarseOffset", UnsignedFull()),
    /**
     ...
     ten dB.
     */
    GenDef("modLFO2Volume", CentBelFs()),
    GenDef("unused1", CentBelFs()),
    // 15
    /**
     ...
     */
    GenDef("chorusEffectsSend", TenthPercent()),
    /**
     ...
     */
    GenDef("reverbEffectsSend", TenthPercent()),
    /**
     This is the degree, in 0.1% units, to which the “daryu”dio output of the note is positioned to the left or right
     ...
     */
    GenDef("pan", TenthPercent()),
    GenDef("unused2", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    GenDef("unused3", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    // 20
    GenDef("unused4", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     */
    GenDef("delayModLFO", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     */
    GenDef("freqModLFO", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     */
    GenDef("delayVibLFO", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     This is the frequency, in absolute cents, of the Vibrato LFO’s triangular period. A value of zero indicates a
     frequency of 8.176 Hz. A negative value indicates a frequency less than 8.176 Hz; a positive value a frequency
     greater than 8.176 Hz. For example, a frequency of 10 mHz would be 1200log2(.01/8.176) = -11610.
     */
    GenDef("freqVibLFO", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    // 25
    /**
     ...
     delay. For example, a delay of 10 msec would be 1200log2(.01) = -7973.
     */
    GenDef("delayModEnv", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     */
    GenDef("attackModEnv", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     1200log2(.01) = -7973.
     */
    GenDef("holdModEnv", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     */
    GenDef("decayModEnv", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     */
    GenDef("sustainModEnv", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    // 30
    /**
     ...
     */
    GenDef("releaseModEnv", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     This is the degree, in timecents per KeyNumber utnoitws,hich the hold time of the Modulation Envelope is decreased
     ...
     */
    GenDef("keynumMod2EnvHold", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     This is thedegree, in timecents per KeyNumber units, to which the hold time of the Modulation Envelope is
     ...
     */
    GenDef("keynumMod2EnvDecay", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     delay. For example, a delay of 10 msec would be 1200log2(.01) = -7973.
     */
    GenDef("delayVolEnv", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     */
    GenDef("attackVolEnv", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    // 35
    /**
     ...
     1200log2(.01) = -7973.
     */
    GenDef("holdVolEnv", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     be 1200log2(.01) = -7973.
     */
    GenDef("decayVolEnv", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     */
    GenDef("sustainVolEnv", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     */
    GenDef("releaseVolEnv", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     */
    GenDef("keynum2VolEnvHold", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    // 40
    /**
     ...
     50 when key number 36 was played, the hold time would be 20 msec.
     */
    GenDef("keynum2VolEnvDecay", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     */
    GenDef("instrument", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    GenDef("reserved1", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     */
    GenDef("keyRange", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     */
    GenDef("velRange", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    // 45
    /**
     ...
     */
    GenDef("startLoopAddrsCoarseOffset", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     */
    GenDef("keynum", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     */
    GenDef("velocity", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     */
    GenDef("initialAttenuation", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    GenDef("reserved2", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    // 50
    /**
     ...
     */
    GenDef("endLoopAddrsCoarseOffset", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     This is a pitch offset, in semitones, which should bpelieadp to the note. A positive value indicates the sound is
     ...
     */
    GenDef("coarseTune", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     */
    GenDef("fineTume", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     */
    GenDef("sampleID", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     sample.
     */
    GenDef("sampleMode", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    // 55
    GenDef("reserved3", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     */
    GenDef("scaleTuning", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     */
    GenDef("exclusiveClass", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
    /**
     ...
     */
    GenDef("overridingRootKey", 0, std::numeric_limits<uint16_t>::max(), 0, GenDef::fromUnsigned),
};
