...
#include "Render/Sample/Source/Sampled/Bounds.hpp"
#include "Render/Sample/Source/Sampled/BufferIndex.hpp"
#include "Render/Sample/Source/Sampled/CanonicalBuffer.hpp"
...
public:
   ...
   */
  Generator(double sampleRate, const CanonicalBuffer& samples, const Bounds& bounds, Interpolator kind = linear) :
  samples_{samples},
  bounds_{bounds},
  interpolator_{kind},
  sampleRateRatio_{samples.header().sampleRate() / sampleRate},
  bufferIndex_{bounds.startPos()}
  {
    samples.load();
  }
