...
std::vector<SFGeneratorDefinition> const SFGeneratorDefinition::definitions_ = {
     ...
     */
    SFGeneratorDefinition("startAddrsOffset", ValueKind::offset, unavailableInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("endAddrsOffset", ValueKind::offset, unavailableInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("startLoopAddrsOffset", ValueKind::offset, unavailableInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("endLoopAddrsOffset", ValueKind::offset, unavailableInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("startAddrsCoarseOffset", ValueKind::coarseOffset, unavailableInPreset),
    // 5
    /**
     ...
     fall one semitone.
     */
    SFGeneratorDefinition("modLFO2Pitch", ValueKind::signedCents, additiveInPreset),
    /**
     ...
     fall one semitone.
     */
    SFGeneratorDefinition("vibLFO2Pitch", ValueKind::signedCents, additiveInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("modEnvToPitch", ValueKind::signedCents, additiveInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("initialFilterFc", ValueKind::signedFreqCents, additiveInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("initialFilterQ", ValueKind::signedCentsBel, additiveInPreset),
    // 10
    /**
     ...
     */
    SFGeneratorDefinition("modLFO2FilterFc", ValueKind::signedShort, additiveInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("modEnv2FilterFc", ValueKind::signedShort, additiveInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("endAddrsCoarseOffset", ValueKind::coarseOffset, unavailableInPreset),
    /**
     ...
     ten dB.
     */
    SFGeneratorDefinition("modLFO2Volume", ValueKind::signedCentsBel, additiveInPreset),
    SFGeneratorDefinition("unused1", ValueKind::signedShort, unavailableInPreset),
    // 15
    /**
     ...
     */
    SFGeneratorDefinition("chorusEffectsSend", ValueKind::unsignedPercent, additiveInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("reverbEffectsSend", ValueKind::unsignedPercent, additiveInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("pan", ValueKind::signedPercent, additiveInPreset),
    SFGeneratorDefinition("unused2", ValueKind::unsignedShort, unavailableInPreset),
    SFGeneratorDefinition("unused3", ValueKind::unsignedShort, unavailableInPreset),
    // 20
    SFGeneratorDefinition("unused4", ValueKind::unsignedShort, unavailableInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("delayModLFO", ValueKind::signedTimeCents, additiveInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("freqModLFO", ValueKind::signedFreqCents, additiveInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("delayVibLFO", ValueKind::signedTimeCents, additiveInPreset),
    /**
     This is the frequency, in absolute cents, of the Vibrato LFO’s triangular period. A value of zero indicates a
     frequency of 8.176 Hz. A negative value indicates a frequency less than 8.176 Hz; a positive value a frequency
     greater than 8.176 Hz. For example, a frequency of 10 mHz would be 1200log2(.01/8.176) = -11610.
     */
    SFGeneratorDefinition("freqVibLFO", ValueKind::signedFreqCents, additiveInPreset),
    // 25
    /**
     ...
     delay. For example, a delay of 10 msec would be 1200log2(.01) = -7973.
     */
    SFGeneratorDefinition("delayModEnv", ValueKind::signedTimeCents, additiveInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("attackModEnv", ValueKind::signedTimeCents, additiveInPreset),
    /**
     ...
     1200log2(.01) = -7973.
     */
    SFGeneratorDefinition("holdModEnv", ValueKind::signedTimeCents, additiveInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("decayModEnv", ValueKind::signedTimeCents, additiveInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("sustainModEnv", ValueKind::unsignedPercent, additiveInPreset),
    // 30
    /**
     ...
     */
    SFGeneratorDefinition("releaseModEnv", ValueKind::signedTimeCents, additiveInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("keynumMod2EnvHold", ValueKind::signedShort, additiveInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("keynumMod2EnvDecay", ValueKind::signedShort, additiveInPreset),
    /**
     ...
     delay. For example, a delay of 10 msec would be 1200log2(.01) = -7973.
     */
    SFGeneratorDefinition("delayVolEnv", ValueKind::signedTimeCents, additiveInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("attackVolEnv", ValueKind::signedTimeCents, additiveInPreset),
    // 35
    /**
     ...
     1200log2(.01) = -7973.
     */
    SFGeneratorDefinition("holdVolEnv", ValueKind::signedTimeCents, additiveInPreset),
    /**
     ...
     be 1200log2(.01) = -7973.
     */
    SFGeneratorDefinition("decayVolEnv", ValueKind::signedTimeCents, additiveInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("sustainVolEnv", ValueKind::signedCentsBel, additiveInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("releaseVolEnv", ValueKind::signedTimeCents, additiveInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("keynum2VolEnvHold", ValueKind::signedShort, additiveInPreset),
    // 40
    /**
     ...
     50 when key number 36 was played, the hold time would be 20 msec.
     */
    SFGeneratorDefinition("keynum2VolEnvDecay", ValueKind::signedShort, additiveInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("instrument", ValueKind::unsignedShort, availableInPreset),
    SFGeneratorDefinition("reserved1", ValueKind::signedShort, unavailableInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("keyRange", ValueKind::range, availableInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("velRange", ValueKind::range, availableInPreset),
    // 45
    /**
     ...
     */
    SFGeneratorDefinition("startLoopAddrsCoarseOffset", ValueKind::coarseOffset, unavailableInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("keynum", ValueKind::unsignedShort, unavailableInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("velocity", ValueKind::unsignedShort, unavailableInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("initialAttenuation", ValueKind::signedCentsBel, additiveInPreset),
    SFGeneratorDefinition("reserved2", ValueKind::unsignedShort, unavailableInPreset),
    // 50
    /**
     ...
     */
    SFGeneratorDefinition("endLoopAddrsCoarseOffset", ValueKind::coarseOffset, unavailableInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("coarseTune", ValueKind::signedSemitones, additiveInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("fineTune", ValueKind::signedCents, additiveInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("sampleID", ValueKind::unsignedShort, unavailableInPreset),
    /**
     ...
     sample.
     */
    SFGeneratorDefinition("sampleMode", ValueKind::unsignedShort, unavailableInPreset),
    // 55
    SFGeneratorDefinition("reserved3", ValueKind::signedShort, unavailableInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("scaleTuning", ValueKind::unsignedShort, additiveInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("exclusiveClass", ValueKind::unsignedShort, unavailableInPreset),
    /**
     ...
     */
    SFGeneratorDefinition("overridingRootKey", ValueKind::signedShort, unavailableInPreset),
};
