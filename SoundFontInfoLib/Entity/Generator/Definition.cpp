...
std::array<Definition, Definition::NumDefs> const Definition::definitions_{
     ...
     */
    Definition("startAddrsOffset", ValueKind::offset, unavailableInPreset),
    /**
     ...
     */
    Definition("endAddrsOffset", ValueKind::offset, unavailableInPreset),
    /**
     ...
     */
    Definition("startLoopAddrsOffset", ValueKind::offset, unavailableInPreset),
    /**
     ...
     */
    Definition("endLoopAddrsOffset", ValueKind::offset, unavailableInPreset),
    /**
     ...
     */
    Definition("startAddrsCoarseOffset", ValueKind::coarseOffset, unavailableInPreset),
    // 5
    /**
     ...
     fall one semitone.
     */
    Definition("modLFO2Pitch", ValueKind::signedCents, additiveInPreset),
    /**
     ...
     fall one semitone.
     */
    Definition("vibLFO2Pitch", ValueKind::signedCents, additiveInPreset),
    /**
     ...
     */
    Definition("modEnvToPitch", ValueKind::signedCents, additiveInPreset),
    /**
     ...
     */
    Definition("initialFilterFc", ValueKind::signedFreqCents, additiveInPreset),
    /**
     ...
     */
    Definition("initialFilterQ", ValueKind::signedCentsBel, additiveInPreset),
    // 10
    /**
     ...
     */
    Definition("modLFO2FilterFc", ValueKind::signedShort, additiveInPreset),
    /**
     ...
     */
    Definition("modEnv2FilterFc", ValueKind::signedShort, additiveInPreset),
    /**
     ...
     */
    Definition("endAddrsCoarseOffset", ValueKind::coarseOffset, unavailableInPreset),
    /**
     ...
     ten dB.
     */
    Definition("modLFO2Volume", ValueKind::signedCentsBel, additiveInPreset),
    Definition("unused1", ValueKind::signedShort, unavailableInPreset),
    // 15
    /**
     ...
     */
    Definition("chorusEffectsSend", ValueKind::unsignedPercent, additiveInPreset),
    /**
     ...
     */
    Definition("reverbEffectsSend", ValueKind::unsignedPercent, additiveInPreset),
    /**
     ...
     */
    Definition("pan", ValueKind::signedPercent, additiveInPreset),
    Definition("unused2", ValueKind::unsignedShort, unavailableInPreset),
    Definition("unused3", ValueKind::unsignedShort, unavailableInPreset),
    // 20
    Definition("unused4", ValueKind::unsignedShort, unavailableInPreset),
    /**
     ...
     */
    Definition("delayModLFO", ValueKind::signedTimeCents, additiveInPreset),
    /**
     ...
     */
    Definition("freqModLFO", ValueKind::signedFreqCents, additiveInPreset),
    /**
     ...
     */
    Definition("delayVibLFO", ValueKind::signedTimeCents, additiveInPreset),
    /**
     This is the frequency, in absolute cents, of the Vibrato LFO’s triangular period. A value of zero indicates a
     frequency of 8.176 Hz. A negative value indicates a frequency less than 8.176 Hz; a positive value a frequency
     greater than 8.176 Hz. For example, a frequency of 10 mHz would be 1200log2(.01/8.176) = -11610.
     */
    Definition("freqVibLFO", ValueKind::signedFreqCents, additiveInPreset),
    // 25
    /**
     ...
     delay. For example, a delay of 10 msec would be 1200log2(.01) = -7973.
     */
    Definition("delayModEnv", ValueKind::signedTimeCents, additiveInPreset),
    /**
     ...
     */
    Definition("attackModEnv", ValueKind::signedTimeCents, additiveInPreset),
    /**
     ...
     1200log2(.01) = -7973.
     */
    Definition("holdModEnv", ValueKind::signedTimeCents, additiveInPreset),
    /**
     ...
     */
    Definition("decayModEnv", ValueKind::signedTimeCents, additiveInPreset),
    /**
     ...
     */
    Definition("sustainModEnv", ValueKind::unsignedPercent, additiveInPreset),
    // 30
    /**
     ...
     */
    Definition("releaseModEnv", ValueKind::signedTimeCents, additiveInPreset),
    /**
     ...
     */
    Definition("keynumMod2EnvHold", ValueKind::signedShort, additiveInPreset),
    /**
     ...
     */
    Definition("keynumMod2EnvDecay", ValueKind::signedShort, additiveInPreset),
    /**
     ...
     delay. For example, a delay of 10 msec would be 1200log2(.01) = -7973.
     */
    Definition("delayVolEnv", ValueKind::signedTimeCents, additiveInPreset),
    /**
     ...
     */
    Definition("attackVolEnv", ValueKind::signedTimeCents, additiveInPreset),
    // 35
    /**
     ...
     1200log2(.01) = -7973.
     */
    Definition("holdVolEnv", ValueKind::signedTimeCents, additiveInPreset),
    /**
     ...
     be 1200log2(.01) = -7973.
     */
    Definition("decayVolEnv", ValueKind::signedTimeCents, additiveInPreset),
    /**
     ...
     */
    Definition("sustainVolEnv", ValueKind::signedCentsBel, additiveInPreset),
    /**
     ...
     */
    Definition("releaseVolEnv", ValueKind::signedTimeCents, additiveInPreset),
    /**
     ...
     */
    Definition("keynum2VolEnvHold", ValueKind::signedShort, additiveInPreset),
    // 40
    /**
     ...
     50 when key number 36 was played, the hold time would be 20 msec.
     */
    Definition("keynum2VolEnvDecay", ValueKind::signedShort, additiveInPreset),
    /**
     ...
     */
    Definition("instrument", ValueKind::unsignedShort, availableInPreset),
    Definition("reserved1", ValueKind::signedShort, unavailableInPreset),
    /**
     ...
     */
    Definition("keyRange", ValueKind::range, availableInPreset),
    /**
     ...
     */
    Definition("velRange", ValueKind::range, availableInPreset),
    // 45
    /**
     ...
     */
    Definition("startLoopAddrsCoarseOffset", ValueKind::coarseOffset, unavailableInPreset),
    /**
     ...
     */
    Definition("keynum", ValueKind::unsignedShort, unavailableInPreset),
    /**
     ...
     */
    Definition("velocity", ValueKind::unsignedShort, unavailableInPreset),
    /**
     ...
     */
    Definition("initialAttenuation", ValueKind::signedCentsBel, additiveInPreset),
    Definition("reserved2", ValueKind::unsignedShort, unavailableInPreset),
    // 50
    /**
     ...
     */
    Definition("endLoopAddrsCoarseOffset", ValueKind::coarseOffset, unavailableInPreset),
    /**
     ...
     */
    Definition("coarseTune", ValueKind::signedSemitones, additiveInPreset),
    /**
     ...
     */
    Definition("fineTune", ValueKind::signedCents, additiveInPreset),
    /**
     ...
     */
    Definition("sampleID", ValueKind::unsignedShort, unavailableInPreset),
    /**
     ...
     sample.
     */
    Definition("sampleMode", ValueKind::unsignedShort, unavailableInPreset),
    // 55
    Definition("reserved3", ValueKind::signedShort, unavailableInPreset),
    /**
     ...
     */
    Definition("scaleTuning", ValueKind::unsignedShort, additiveInPreset),
    /**
     ...
     */
    Definition("exclusiveClass", ValueKind::unsignedShort, unavailableInPreset),
    /**
     ...
     */
    Definition("overridingRootKey", ValueKind::signedShort, unavailableInPreset),

    Definition("initialPitch", ValueKind::unsignedShort, unavailableInPreset),
};
